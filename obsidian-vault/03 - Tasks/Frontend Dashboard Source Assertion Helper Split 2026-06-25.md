...
- [x] Continue source assertion helper re-scan candidates `worklog-card-list-source-assertions.ts` and `notifications-source-assertions.ts` 처리 완료. See [[Frontend Worklog Card List Source Assertion Helper Split 2026-06-25]] and [[Frontend Notifications Source Assertion Helper Split 2026-06-25]].
- [ ] Current next source assertion helper candidate after worklog-card-list/notifications split: `landing-preview-source-assertions.ts` at 37 pure LOC.
