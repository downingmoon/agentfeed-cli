...
- [x] `dashboard-strict-fields.contract.test.ts` handled in [[Frontend Dashboard Strict Field Fixture Split 2026-06-18]]. `user-account-response-guards.contract.test.ts` handled in [[Frontend User Account Response Guard Assertion Move 2026-06-18]].
