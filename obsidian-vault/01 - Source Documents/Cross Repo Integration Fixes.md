---
title: Cross Repo Integration Fixes
aliases:
...
tags:
  ...
  - source-doc
  - todo
source_path: docs/todo/cross-repo-integration-fixes.md
status: synced-copy
created: 2026-05-30
updated: 2026-05-30
---
...
> [!info] 원본 문서 복사본
> 원본: `docs/todo/cross-repo-integration-fixes.md`. 이 파일은 Obsidian 탐색과 wikilink 연결을 위한 Vault 내부 복사본입니다.
...
- [x] Backend ingest 중복 방지를 DB partial unique index까지 강화한다.
  - `source_identity_hash` + `(author_id, source_identity_hash)` active-row unique index로 병렬/재시도 중복 생성 리스크 축소
