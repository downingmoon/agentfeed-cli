...
- [ ] Next source assertion helper candidates are `worklog-card-list-source-assertions.ts`, `notifications-source-assertions.ts`, and `landing-preview-source-assertions.ts` at 37 pure LOC.
