...
- Later fixture/assertion ownership was split; valid preservation assertions now live in `project-schema-variant-strict-field-assertions.ts` and malformed cases in `project-schema-variant-fixtures.ts` / `project-schema-variants-malformed-strict-fields.contract.test.ts`.
...
- `src/lib/project-schema-variants-strict-fields.contract.test.ts`: originally 175 pure LOC; 2026-06-18 split result is 5 pure LOC runner plus 50 pure LOC assertion helper
