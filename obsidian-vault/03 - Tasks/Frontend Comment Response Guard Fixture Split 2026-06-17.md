...
- [x] Keep comment response guard fixtures and malformed cases in `comment-response-guard-fixtures.ts`; assertion ownership split preserved that boundary in [[Frontend Comment Response Guard Assertion Move 2026-06-19]].
- [x] Re-scan found `settings-profile-save.contract.test.ts` tied as the largest contract file and moved expectations in [[Frontend Settings Profile Save Expectation Move 2026-06-17]].
