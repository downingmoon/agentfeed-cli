...
- [x] `project-mutation-contracts.contract.test.ts` handled in [[Frontend Project Mutation Contract Helper Move 2026-06-18]]. Remaining next re-scan candidates: `settings-profile-validation-save.contract.test.ts`, `integration-status-contracts.contract.test.ts`, and `me-client-mutation-contracts.contract.test.ts` tied at 61 pure LOC.
