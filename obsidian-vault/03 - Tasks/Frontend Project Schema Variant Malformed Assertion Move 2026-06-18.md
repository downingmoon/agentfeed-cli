...
- [x] Next re-scan candidate `api-surface-contracts.contract.test.ts` handled in [[Frontend API Surface Fixture Split 2026-06-18]]. Subsequent candidates `read-side-strict-fields.contract.test.ts`, `api-pagination-request-contracts.contract.test.ts`, and `worklog-metric-evidence.contract.test.ts` handled in [[Frontend Read Side Strict Field Fixture Split 2026-06-18]], [[Frontend API Pagination Request Fixture Split 2026-06-18]], and [[Frontend Worklog Metric Evidence Fixture Split 2026-06-18]]. Current next re-scan candidate: `project-schema-variants-strict-fields.contract.test.ts` at 45 pure LOC.
