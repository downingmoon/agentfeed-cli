...
- `src/lib/leaderboard-user-key.contract.test.ts` 추가. 2026-06-19 [[Frontend Leaderboard User Key Assertion Move 2026-06-19]]에서 runner-owned malformed row fixture/assertion flow를 `src/lib/leaderboard-user-key-assertions.ts`로 이동했다.
...
- LOC
  ...
  - `src/lib/leaderboard-user-key.contract.test.ts`: originally 40 pure LOC; 2026-06-19 split result is 3 lines / 2 pure LOC runner plus 47 lines / 44 pure LOC assertion helper
