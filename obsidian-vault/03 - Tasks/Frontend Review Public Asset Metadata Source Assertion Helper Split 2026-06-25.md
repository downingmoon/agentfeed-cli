...
- [x] Next source assertion helper candidate `profile-page-data-source-assertions.ts` handled by [[Frontend Profile Page Data Source Assertion Helper Split 2026-06-25]].
