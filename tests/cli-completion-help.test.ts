...
describe('CLI completion help', () => {
  ...
  it('prints a zsh completion script for completion zsh', async () => {
    ...
    expect(stdout).toContain("'--source[Select agent source]:source:(claude-code codex cursor antigravity-cli other)'");
  ...
  it('prints a bash completion script for completion bash', async () => {
    ...
    expect(stdout).toContain('--source) COMPREPLY=( $(compgen -W "claude-code codex cursor antigravity-cli other" -- "$cur") ); return 0 ;;');
  ...
  it('prints a fish completion script for completion fish', async () => {
    ...
    expect(stdout).toContain('complete -c agentfeed -n "__fish_seen_subcommand_from collect" -l source -r -a "claude-code codex cursor antigravity-cli other" -d "Select agent source"');
