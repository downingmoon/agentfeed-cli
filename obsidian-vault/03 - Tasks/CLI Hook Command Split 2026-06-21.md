...
> [!todo]
> `src/cli/index.ts` remains above the 250 pure LOC target because collect/share/publish and help/completion dispatch still live there. Next structural slices should prefer the most isolated command with strong existing tests.
