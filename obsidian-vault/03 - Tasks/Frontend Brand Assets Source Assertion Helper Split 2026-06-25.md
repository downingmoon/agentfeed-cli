...
- [ ] Continue source assertion helper re-scan before adding cases near 200 pure LOC. Current next candidate: `profile-page-source-assertions.ts` at 65 pure LOC.
